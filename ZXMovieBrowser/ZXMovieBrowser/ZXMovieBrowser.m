...
@property (nonatomic, strong, readwrite) FXBlurView     *blurView;
...
- (void)setCurrentMovieIndex:(NSInteger)index
{
    if (index >= 0 && index < self.movies.count) {
        ...
        [self backgroundViewMakeFadeAnimation];
    }
}
...
- (void)backgroundViewMakeFadeAnimation
{
